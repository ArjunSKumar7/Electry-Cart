...
module.exports={
    ...
    placeOrder:(orderData,subtotal,total,userId)=>{
        ...
        return new Promise(async (resolve, reject)=>{
            ...
            if (order) {
                await orderschema.order.updateOne({ userid: orderData.userId },
                    {
                        '$push':
                        {
                            'orders': orderdata
    ...
    viewOrderDetails: (orderId) => {
        return new Promise(async (resolve, reject) => {
            ...
            let productid = await orderschema.order.findOne({ "orders._id": orderId }, { 'orders.$': 1 });
    ...
    createData: (details, dates) => {
      ...
      cancelOrder: (orderId, userId) => {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            await orderschema.order.updateOne({ 'orders._id': orderId },
                {
                    $set:
                    {
