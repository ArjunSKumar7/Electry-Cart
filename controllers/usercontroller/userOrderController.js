...
module.exports = {
  getOrderPage: async (req, res) => {
    try {
      ...
      await userOrderHelpers
        .orderPage(req.session.user._id)
        .then((response) => {
  ...
  getCancelOrder: async (req, res) => {
    try {
      await userOrderHelpers
        .cancelOrder(req.query.orderid, req.session.user._id)
        .then((response) => {
          res.json(response);
        });
    } catch (error) {
  ...
  getReturnOrder: async (req, res) => {
    try {
      await userOrderHelpers
        .returnOrder(req.query.orderid, req.session.user._id)
        .then((response) => {
          res.json(response);
        });
    } catch (error) {
  ...
  getSuccessPage:async (req, res) => {
    ...
    res.render("user/success",{wishcount,cartcount});
  },
